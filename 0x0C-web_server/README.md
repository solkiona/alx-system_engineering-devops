# Web server
Project done during **ALX Software Engineering studies**. It aims to learn about the roles of web servers and their processes (parent and child), and DNS roles.

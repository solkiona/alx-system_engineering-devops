...
Project done during **ALX SOFTWARE ENGINEERING PROGRAMME**. It aims to learn about PID, processes and commands that handles them (`ps`, `pgrep`, `pkill`, `kill`, etc) in **Bash**.
